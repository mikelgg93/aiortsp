...
from aiortsp.transport import RTPTransport, RTPTransportClient, transport_for_scheme
...
class RTSPReader(RTPTransportClient):
    ...
    def __init__(
        ...
        **_,
        ...
        self._runner = None
        self.connection: RTSPConnection | None = None
        self.transport: RTPTransport | None = None
        self.session: RTSPMediaSession | None = None
    ...
    async def run_stream_loop(self):
        ...
        while True:
            try:
                ...
                self.logger.error(
                    "Stopping run loop for %s", sanitize_rtsp_url(self.media_url)
                )
                break
